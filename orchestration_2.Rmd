...
PSI and CSI evaluate the current quarter's through-the-door applications — the model's input distribution. Performance metrics (KS, DQ90) use a different cohort; see the KS section for the two-cohort rationale.
